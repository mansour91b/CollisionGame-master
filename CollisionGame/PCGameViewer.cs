...
namespace CollisionGame
{
    ...
    /// </summary>
    public class PCGameViewer : Game
    {
        long DataBaseId;
           ...
           if(logic.isDead)
            {
                ...
                System.DateTime dateTimeVariable = DateTime.Now;

                
                
                int score = (int)logic.playerScore;

                //score = aTimer;
                MySqlCommand cmd = new MySqlCommand("insert Into Results (Score, UserID, TimeStamp) values (?score, ?userid, @value)", mySqlConnection);
